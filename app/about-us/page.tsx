...
export default function AboutUs() {
  return (<main className="w-full h-full bg-white flex flex-col items-center p-20 justify-center">
    <div className="flex flex-col gap-4 items-center justify-center">
      <span className="text-brand-second  text-3xl lg:text-6xl">Sobre nós</span>
      <span className="text-brand-primary text-1xl lg:text-2xl">    Somos uma empresa focada em auxiliar na produtividade empresarial e diária do usuário. <br />
